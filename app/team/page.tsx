...
const team = [
  { initials: "AS", name: "Aaziq Ali Shah", role: "Chief Executive Officer", bio: "Aaziq leads HashSync's vision and product-engineering philosophy, with direct responsibility for the quality, direction, and delivery of the products the team creates.", image: "/aaziq-ali-shah-studio.jpg" },
  ...
  { initials: "AH", name: "Ammara Hashmi", role: "UI/UX Designer", bio: "Ammara shapes clear, thoughtful interfaces and user journeys that turn product requirements into accessible and polished digital experiences." },
  ...
  { initials: "MS", name: "Muhammad Shariq", role: "HR Manager", bio: "Muhammad supports the people and culture behind HashSync, fostering collaboration, accountability, and professional growth across the team." },
  ...
  { initials: "UH", name: "Usman Hashmi", role: "Flutter Developer", bio: "Usman develops cross-platform mobile applications in Flutter with a focus on reliable functionality, product quality, and a consistent user experience." },
  ...
  { initials: "UK", name: "Usama Khan", role: "Associate Software Engineer", bio: "Usama supports application engineering across features and integrations, bringing careful implementation and collaborative problem-solving to the team." },
  { initials: "AT", name: "Alisha Tariq", role: "Database Design Analyst", bio: "Alisha works on database structure and data design, helping products organize, protect, and use information efficiently as they grow." },
  ...
  { initials: "JS", name: "Javeria Shah", role: "SQA Specialist", bio: "Javeria focuses on software quality assurance, validating product behavior and helping the team identify issues before they reach users." },
  { initials: "ZZ", name: "Zaeema Zahoor", role: "Business Development Executive", bio: "Zaeema connects client needs with HashSync's capabilities, supporting early conversations and long-term relationships with clarity and care." },
];
