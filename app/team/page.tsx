...
const team = [
  ...
  { initials: "UH", name: "Usman Amir", role: "Flutter Developer", bio: "Usman develops cross-platform mobile applications in Flutter with a focus on reliable functionality, product quality, and a consistent user experience." },
