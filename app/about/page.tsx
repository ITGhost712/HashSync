...
export default function AboutPage() {
  return <main><SiteHeader />
    <header className="subpage-hero shell"><p className="eyebrow"><span /> About HashSync</p><h1>Technical capability.<br /><em>Genuine responsibility.</em></h1><p>HashSync is an Islamabad-based product engineering company helping startups and businesses turn complex ideas into dependable, real-world software.</p></header>
    ...
    <section className="leadership shell"><div className="leadership-image"><img src="/aaziq-ali-shah.jpeg" alt="Aaziq Ali Shah, CEO of HashSync" /><span>Aaziq Ali Shah<br /><small>CEO, HashSync</small></span></div><div className="leadership-copy"><p className="eyebrow"><span /> Leadership</p><h2>Visible leadership. Direct accountability.</h2><blockquote>“We are building HashSync around a simple idea—combine strong technical capability with genuine responsibility for the products we create.”</blockquote><div className="leader-list"><div><b>Aaziq Ali Shah</b><span>Chief Executive Officer</span></div><div><b>Zulkaif Umer Shah</b><span>Chief Operating Officer</span></div></div></div></section>
