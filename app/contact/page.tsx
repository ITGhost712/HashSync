...
export default function ContactPage() {
  return <main><SiteHeader />
    <section className="contact-page shell">
      <div className="contact-page-copy"><p className="eyebrow"><span /> Start a project</p><h1>Tell us what<br />you&apos;re <em>building.</em></h1><p>Share the product idea, technical challenge, or existing system you want to improve. We&apos;ll review it and come back with a clear next step.</p><div className="contact-facts"><div><span>Email</span><a href="mailto:aaziq@hash-sync.com">aaziq@hash-sync.com</a></div><div><span>Location</span><b>Avenue Mall, DHA Phase 1<br />Islamabad, Pakistan</b></div><div><span>Collaboration</span><b>Pakistan · International · Remote</b></div></div></div>
      <form className="project-form" action="mailto:aaziq@hash-sync.com" method="post" encType="text/plain">
        <div className="field-pair"><label>Your name<input name="name" type="text" autoComplete="name" required placeholder="Name" /></label><label>Work email<input name="email" type="email" autoComplete="email" required placeholder="you@company.com" /></label></div>
